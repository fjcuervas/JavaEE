...
public class GestorPersistencia {
	...
	public Automovil consultarAutomvilPorId(String matricula, String matPais) {
		return em.find(Automovil.class, new AutomovilPK(matricula, matPais));
	}
	...
	public boolean insertarAutomovil(Automovil automovil) {
		EntityTransaction tx = em.getTransaction();
		tx.begin();
		try {
	...
	public boolean insertarAreaGeografica(AreaGeografica area) {
		EntityTransaction tx = em.getTransaction();
		tx.begin();
		try {
			em.persist(area);
	...
	public AreaGeografica consultarAreaGeograficaPorId(String id) {
		return em.find(AreaGeografica.class, id);
	}
